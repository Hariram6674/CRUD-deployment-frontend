...
function EditStudent()
{
    ...
    useEffect(()=>{
        Axios.get("https://backend-for-crud-operations.onrender.com/studentRoute/update-student/"+id)
        .then((res)=>{
            if(res.status === 200){
    ...
    const handleSubmit = () => {
        ...
        Axios.put("https://backend-for-crud-operations.onrender.com/studentRoute/update-student/"+id, data)
        .then((res)=>{
            if(res.status === 200)
